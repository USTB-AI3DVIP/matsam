...
# from model.nets.unet_2 import UNet
...
from model.nets.attunet import AttUNet
...
def train_net(net, device, train_data, val_data, epochs=20, batch_size=5, lr=0.0001, model_name='unet_model.pth'):
    """ Train """
...
if __name__ == '__main__':
    ...
    # Configure Image Transformer Crop Block Size
